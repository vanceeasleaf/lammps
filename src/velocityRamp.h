...
CommandStyle(velocityRamp,VelocityRamp)

#else

#ifndef LMP_VELOCITYRAMP_H
#define LMP_VELOCITYRAMP_H

#include "pointers.h"

namespace LAMMPS_NS {

class VelocityRamp : protected Pointers {
 public:
  VelocityRamp(class LAMMPS *);
  void command(int, char **);
  void init_external(const char *);
  void options(int, char **);
  void create(double, int,int,char **);
